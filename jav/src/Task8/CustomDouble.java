...
public class CustomDouble {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Double.hashCode(fraction);
        result = 31 * result + Boolean.hashCode(minus);
    ...
    public static void main(final String[] args) {
        final CustomDouble test1 = new CustomDouble(-5, -0.5);
        final CustomDouble test2 = new CustomDouble(-4, -3.0);
